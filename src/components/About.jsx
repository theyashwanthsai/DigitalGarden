...
function About() {
  return(
    <div className = "p-5 flex items-center justify-center flex-col text-left pt-20 pb-6">
      ...
      <p className="p-2 text-lg md:w-2/4 mb-6 font-semibold">Hello, I am Sai Yashwanth, a Computer Science Engineer from Bangalore currently pursuing my undergrad from PES University.
